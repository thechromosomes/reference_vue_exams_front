...
</label><button class="btn q_prvw_sbmtbtn" type="button" @click="submitkfpanswer">Submit</button></div><!--button_previw-->
</div>
</div>
    <!--selection_section-->
...
var username=localStorage.username;
  export default {
   ...
   axios.post(`/kfpquestionanswer`,{anonymouscheck:this.anonymouscheck,questionid:this.masterquestion,createdby:this.currentuser,answerdata:this.questiondata})
          .then(response => {
 console.log('question submit after');
      ...
      getquestiondata(){
        axios.post(`/getquestionforanswer`,{"questionid":this.masterquestion,"loggedinuser":this.masteruserid})
    .then(response => {
