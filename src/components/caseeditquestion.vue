...
<li class="add_image_button">
  <span class="right_icon"><img src="../assets/icons/plus-circle_white.svg" class="ins_icon" /></span>
  <span class="file_text">Add Image </span>
  <!-- <input type="file" class="file_input" :ref="`stemfile${questionindex}`" :key="`stemfile${questionindex}`" :id="`stemfile${questionindex}`" @change="attacharticlesecfile('stemfile'+questionindex,questionindex)" multiple/> -->
<input type="file" class="file_input" :ref="`stemfile${questionindex}`" :key="`stemfile${questionindex}`" :id="`stemfile${questionindex}`" @change="attacharticlesecfile('stemfile'+questionindex,questionindex)" multiple/>
...
<li @click="addnewcasequestion"><span class="right_icon"><img src="../assets/icons/plus-circle_white.svg" class="ins_icon" /></span>Add new question set</li>
</ul>
</div>
<div class="col-md-12">
<div class="form-group">
...
<!-- {{'publishcheck--'+publishstatus}} -->
</div> 
<!-- <div v-if="oldq_version==question_version">
  <button v-if="publishstatus==0" class="save_fields btn" @click="publishquestion" >Publish</button>
  <template>
