...
export default {
  ...
  data: () => ({
    loaded: false,
        ...
        headers: [
          ...
          {text: 'View', align: 'left', sortable: true, value: '' }
  ...
  methods:{
    ...
    try {
if(this.charttype==0){
     await axios.post(`/getmostviews`,{'userid':this.currentuser})
    .then(mostcomments => {
      // JSON responses are automatically parsed.
      console.log("most views-",mostcomments.data)
  this.mostviews=mostcomments.data;
    }).catch(e => {
      this.errors.push(e)
    })
}
